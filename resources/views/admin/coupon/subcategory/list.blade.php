            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Coupon Sub-Category</a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-header-right">
                                        <a href="{{ route('admin.coupon.sub.category.create') }}"
                                            ...
                                            <a href="{{ route('admin.coupon.sub.category.create') }}"
                                            class="btn btn-info">Main category Add</a>
                                    </div>
                                    ...
                                    <table id="table_id" class="display table-striped ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $d->created_at }}</td>
                                                <td>
                                                    <a href="{{ route('admin.coupon.sub.category.edit', [$d->id]) }}"
                                                        class="text-info">Edit</a> |
                                                    <a href="{{ route('admin.coupon.category.delete', [$d->id]) }}"
