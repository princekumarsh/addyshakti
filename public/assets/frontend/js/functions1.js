$(document).ready(function () {
    ...
    $(".category-select li > a").on("click", function (e) {
        ...
        var val = t.data("attr"),
            list = t.parents("ul");
        (a = list.prevAll("a").find("span")), (input = list.prevAll("input"));
    ...
    $(".description .more-link a, .description .less-link a").on(
        "click",
        function (e) {
            e.preventDefault();
    ...
    $(".claim_reward_form form button").on("click", function (e) {
        ...
        if (
            t.prevAll(".extra_form").html() != "undefied" &&
            t.prevAll(".extra_form").is(":hidden")
        ) {
            e.preventDefault();
